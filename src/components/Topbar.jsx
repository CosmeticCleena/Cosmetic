...
const Topbar = () => {
  return (
    <div className="w-full px-[20px] py-[4px] sm:px-[30px] md:px-[40px] lg:px-[60px] xl:px-[465px] md:py-[14px] bg-black text-white flex items-center justify-center h-[16px] md:h-[55px]">
