      ...
      <div className="relative z-20 h-full w-full flex items-center">
        <div className="absolute w-[90%] md:w-[60%] lg:w-[40%] text-center md:text-start top-1/2 transform -translate-y-1/2 left-[5%] lg:left-[10%] flex flex-col">
          <div className="flex-grow overflow-hidden">
            ...
            <p className="font-svn-avo text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl mb-3 sm:mb-4 md:mb-5 lg:mb-6 line-clamp-3 md:line-clamp-none">
              {HeroData.description}
            </p>
          </div>
          <div className="mt-2">
            <button className="font-svn-avo bg-gradient-to-r from-[#B08B3B] to-[#EAC980] text-xs sm:text-sm md:text-md px-4 sm:px-6 md:px-8 py-1.5 sm:py-2 md:py-3 transition duration-300 whitespace-nowrap">
              {HeroData.buttonText}
            </button>
          </div>
        </div>
